...
try {
    ...
    .json({
        message: `Neq Medicine has been created`,
        data: newMedicine
    })
} catch (error) {
...
const updateMedicine = async (req:Request,res: Response) => {
    try {
        // membaca id obat yang dikirimkan ke parameter URL
        const id = req.params.id

        // Cek exisiting medicine based on id
    ...
    if(!findMedicine) {
        ...
        // Mengcantumkan seluruhnya name, stock, price, type, exp_date
